...
<template>
    <aside class="ml-[-100%] fixed z-20 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen shadow transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] bg-white" :class="sidebar ? 'ml-0':''">
        <div>
    ...
    <div class="ml-auto lg:w-[75%] xl:w-[80%] 2xl:w-[85%] bg-gray-50">
        <div class="sticky z-10 top-0 h-16 shadow bg-white lg:py-2.5 flex items-center">
            <div class="px-6 flex items-center justify-between w-full">
                <button class="w-12 h-16 -mr-2 border-r lg:hidden" @click.prevent="showSidebar">
