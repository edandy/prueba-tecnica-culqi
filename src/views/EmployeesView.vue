    ...
    <layout>
        ...
        <div v-else class="bg-white p-4 rounded-lg">
            ...
            <div class="flex mb-3 text-sm items-center justify-between gap-4">
                <div class="relative w-9/12 group">
            ...
            <div class="flex justify-between items-center text-sm">
                <nav v-if="filters.limit < total" aria-label="Pagination" class="flex items-center text-gray-600 gap-2">
                ...
                <div class="text-gray-600 flex justify-between gap-3 items-center">
                    <p>Mostrando {{ to }} a {{ from }} de {{ total }} registros</p>
